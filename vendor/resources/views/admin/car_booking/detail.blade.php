...
<div class="panel panel-default carbookcls">
    <div class="panel-body">
        <div id="car-list-area" class="section-padding">
            ...
            @endif
            <div ><h3 class="page-title">{{ trans('labels.bookingDetail') }}</h3><a href="{{ route('carBooking.list') }}" class="btn btn-success">{{ trans('labels.cancel') }}</a>
            </div>
                        ...
                        <div class="col-md-6 car-detl-cls">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="select2 form-control" onchange="changeStatus('{{route("rentalCar.status",['id'=>$carBooking->id])}}',this.value)">
                                    ...
                                    <option value="Pending" @if($carBooking->status == 'Pending')selected @endif>Pending</option>
                                    <option value="Accept" @if($carBooking->status == 'Accept') selected @endif>Accept</option>
                                    <option value="Deliver It" @if($carBooking->status == 'Deliver It') selected @endif>Deliver It</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
