                    ...
                    <div class="centerdiv">
                        <div class="subcenter"> 
                          ...
                          <div class="form-group" >
                              <label for="store">{{ trans('labels.store') }} </label>
                          ...
                          <div class="form-group" >
                              <label for="category">{{ trans('labels.category') }} </label>
                          ...
                          <div class="form-group">
                              <label for="quantity">{{ trans('labels.quantity') }} <span class="clsred">*</span></label>
                              <input type="number" name="quantity" value="{{ $product['quantity'] }}" class="form-control" required autofocus>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="size" required value="{{ $product['size'] ? $product['size'] : '' }}" class="form-control" autofocus>
                          </div>
