...
@section('iamge')
  @if(count($car_img) > 0) 
    @if(file_exists(public_path().'/propertyImage/'.$car_img[0]->img_name)  && $car_img[0]->img_name != '')
      <?php echo asset('').'public/propertyImage/'.@$car_img[0]->img_name ;?>
    @else 
...
@section('title')
  @if($car_Detail->property_name != '')
    <?php echo @$car_Detail->property_name; ?>
  @else
   <?php echo "Iraq car"; ?>
  @endif
@endsection
...
<section id="car-list-area" class="section-padding">
        <div class="container">
            <div class="car-mode car-deta-res">
                            <div class="car-mdel">
                                <h4><?php echo $car_Detail->property_name; ?></h4>
                            </div>
                             <div class="regis">
                                <h4><?php
                           ...
                           <div id="detail-slider" class="slider owl-carousel"> 
                            ...
                            if (count($car_img) > 0) { 
                                    foreach ($car_img as $key => $value) { ?>
                               		<div class="item"> 
                                     	<img src="{{ url('/public/propertyImage/'.$value->img_name ) }}" alt="JSOFT">
                                  	</div> 
                           		<?php } 
                                } else { ?>
