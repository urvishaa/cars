			...
			<div class="login_info">
				<div class="log_info_left">
					...
					<form method="post" action="{{ URL::to('/checkuserLogin') }}">
						...
						<p class="crt-acunt">{{ trans("labels.Don't_have_an_account?") }}<a href="{{ URL::to('/register') }}" >{{ trans('labels.Create your account') }},</a>{{ trans('labels.it_takes_less_than_a_minute') }}</p>
					 </form>
				</div>	
			</div>
			<div class="login_img">
