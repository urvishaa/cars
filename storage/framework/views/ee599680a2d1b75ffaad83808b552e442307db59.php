...
<h3 class="page-title"><?php echo e(trans('labels.newProCategory')); ?></h3>   


        <div class="panel panel-default programcrcls">
            
             <div class="panel-body">
                <form action="<?php echo e(url('admin/procategory/save')); ?>" method="POST" enctype="multipart/form-data">
