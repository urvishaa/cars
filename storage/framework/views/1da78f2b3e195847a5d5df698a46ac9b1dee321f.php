...
"><!-- <b> <?php echo e(trans('labels.welcome_message')); ?><?php echo e(trans('labels.welcome_message_to')); ?></b> -->
  <img src="<?php echo $new.'/resources/assets/img/property_logo.png'; ?>">
</div>
  </div>
  <!-- /.login-logo -->
     ...
     <!--    <span class="glyphicon glyphicon-envelope form-control-feedback"></span> -->
      ...
      <div class="form-group has-feedback">
        <select name="language" id="language" class="form-control" class="field" field-validate>
            <option value="en"><?php echo e(trans('labels.englishLanguage')); ?></option>                          
            <option value="ar"><?php echo e(trans('labels.arabicLanguage')); ?></option>                          
            <option value="ku"><?php echo e(trans('labels.kurdishLanguage')); ?></option>                          
        </select>
       
       <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                   <?php echo e(trans('labels.AdminlanguageText')); ?></span>
      <!--   <span class="glyphicon glyphicon-lock form-control-feedback"></span> -->
       <span class="help-block hidden"><?php echo e(trans('labels.AdminlanguageText')); ?></span>
