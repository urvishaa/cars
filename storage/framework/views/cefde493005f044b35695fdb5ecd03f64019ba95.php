...
$(document).ready(function () { 
    $('#tabuserid').DataTable({
        ...
        "serverSide": true,
        "ajax":{
                 "url": "<?php echo e(url('/admin/companyAdmin/allsearch')); ?>",
                 "dataType": "json",
                 "type": "POST",
   ...
   /* $('#category').on( 'change', function () {
    ...
    <div class="box-header-main">
        <h3 class="page-title"><?php echo e(trans('labels.rentalCompanies')); ?> </h3>    
        <p><a href="<?php echo e(url('/admin/companyAdmin/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("admin/companyAdmin/alldelete")); ?>',
