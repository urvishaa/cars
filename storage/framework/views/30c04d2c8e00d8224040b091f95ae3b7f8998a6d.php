...
<h3 class="page-title"><?php echo e(trans('labels.createTopProperty')); ?></h3>   
        ...
        <div class="panel panel-default programcrcls">
             ...
             <div class="panel-body">
                <form action="<?php echo e(url('admin/topProperty')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="centerdiv">
                        <div class="subcenter">      
                          <div class="form-group">
                            <label for="mainProId"><?php echo e(trans('labels.propertyCategory')); ?> <span class="clsred">*</span></label>
                          ...
                          <script type="text/javascript">
                              ...
                              {  
                                  $.ajax({
                                      type: "POST",
                                      url: "<?php echo e(url('admin/topProperty/getPropertyId')); ?>",
