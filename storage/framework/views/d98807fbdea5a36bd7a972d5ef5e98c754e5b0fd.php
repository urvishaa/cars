...
/*function filterGlobal () {
    ...
    $(document).ready(function () { 
        $('#tabuseridpos').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "<?php echo e(url('admin/city/allposts')); ?>",
                     "dataType": "json",
                     "type": "POST",
    ...
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.city')); ?></h3>    
    <p><a href="<?php echo e(url('/admin/city/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.City List')); ?>
                ...
                <thead>
                    <tr>                        
                        ...
                        <th><?php echo e(trans('labels.name')); ?></th>
                         <th><?php echo e(trans('labels.Arabic')); ?></th>
                          <th><?php echo e(trans('labels.Kurdish')); ?></th>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("/admin/city/cityalldelete")); ?>',
