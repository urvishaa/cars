...
<script>
    ...
    $(document).ready(function () { 
        $('#tabuseridpos').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "<?php echo e(url('admin/year/allposts')); ?>",
                     "dataType": "json",
                     "type": "POST",
...
<?php //exit; ?>
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.year')); ?></h3>    
    <p><a href="<?php echo e(url('/admin/year/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.yearList')); ?>
        ...
        <div class="prolisttabcls">
                ...
                <thead>
                    <tr>                        
                        ...
                        <th><?php echo e(trans('labels.year')); ?></th>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("/admin/year/yearalldelete")); ?>',
