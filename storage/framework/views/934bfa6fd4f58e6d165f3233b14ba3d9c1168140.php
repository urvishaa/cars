                    ...
                    <div class="centerdiv">
                        <div class="subcenter">
                            ...
                            <div class="form-group">
                                ...
                                <?php if($user->image != ""): ?>
                                    <div class="col-md-2"><img src="<?php if(isset($user->image)): ?><?php echo e(url('/public/profileImage/'.$user->image )); ?> <?php endif; ?>" class="btn popup_image" height="100px" width="100px"/>
                                <?php else: ?>
                                    <div class="col-md-2"><img src="<?php echo e(url('/public/default-image.jpeg' )); ?>" class="btn popup_image" height="100px" width="100px"/>
                                <?php endif; ?>
