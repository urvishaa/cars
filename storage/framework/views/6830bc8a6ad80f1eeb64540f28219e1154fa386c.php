...
function filterGlobal () {
    ...
    $(document).ready(function () { 
        $('#tabuseridpos').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "<?php echo e(url('admin/ads/allposts')); ?>",
                     "dataType": "json",
                     "type": "POST",
    ...
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.ads')); ?></h3>    
    <p><a href="<?php echo e(url('/admin/ads/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.adsList')); ?>
...
$( document ).ready(function() {
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            var res=confirm('Are you Sure you want to delete ads?');
            if(res=="flase")
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("/admin/ads/alldelete")); ?>',
        ...
        else   {  alert('Select atleast one ads'); }
    });
});
