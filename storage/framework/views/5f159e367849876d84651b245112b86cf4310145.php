          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class=" active tab-pane" id="profile">
                ...
                <!-- The timeline -->
                    <form action="<?php echo e(url('admin/companyAdmin/updateShowRoomAdmin/'.$ShowRoomAdmin->myid)); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="tab-pane" id="passwordDiv">
                <form action="<?php echo e(url('admin/companyAdmin/updateAdminPassword/'.$ShowRoomAdmin->myid)); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  { 
    ...
    $.ajax({
        url: "<?php echo e(url('/admin/companyAdmin/zones')); ?>",
