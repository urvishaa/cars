...
<h3 class="page-title"><?php echo e(trans('labels.editProperty')); ?></h3>  
        ...
        <div class="panel panel-default programcrcls">
             ...
             <div class="panel-body">
                <form action="<?php echo e(url('admin/car/'.$property->id)); ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label for="usertype"><?php echo e(trans('labels.userType')); ?> <span class="clsred">*</span></label>
                                  <select name="userType" id="usertype" class="field"  autofocus required>
                                      ...
                                      <option value="3" <?php if($property->userType == 3) { echo 'selected'; } ?>><?php echo e(trans('labels.company')); ?></option>                                                                
                                  </select>
                          </div>
                                  ...
                                  <select name="companyId" id="companyId" class="field">
                                       <option value=""><?php echo e(trans('labels.company')); ?></option>
                                          <?php $__empty_1 = true; $__currentLoopData = $Company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Com): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
                                                <option <?php if($property->companyId == $Com->myid): ?> selected="" <?php endif; ?> value="<?php echo e($Com->myid); ?>"><?php echo e($Com->first_name); ?> <?php echo e($Com->last_name); ?></option>   
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>    
                                          <?php endif; ?>                                  
                                  </select>
                          </div>
                         ...
                         <div class="form-group" id="twostep" style="display:none;">
                              <label for="pro_type"><?php echo e(trans('labels.propertyType')); ?> <span class="clsred">*</span></label>
                                <select name="pro_type2" id="pro_type1" class="field"   >                              
                                      <option  <?php echo e($property->pro_type ==  $property_type[0]->id ? 'selected="selected"' : ''); ?> value="<?php echo e($property_type[0]->id); ?>"><?php echo e($property_type[0]->name); ?></option>                                
                                </select>
                          </div>
                          ...
                          <div class="form-group" id="threestep" style="display:none;">
                              <label for="pro_type"><?php echo e(trans('labels.propertyType')); ?> <span class="clsred">*</span></label>
                                <select name="pro_type3" id="pro_type2" class="field"   >                              
                                      <option <?php echo e($property->pro_type ==  $property_type[1]->id ? 'selected="selected"' : ''); ?> value="<?php echo e($property_type[1]->id); ?>"><?php echo e($property_type[1]->name); ?></option>                                
                                </select>
                          </div>
                          ...
                          <div class="form-group" >
                              ...
                              <input type="text" name="sale_price" value="<?php echo e($property->sale_price ? $property->sale_price : 0); ?>" class="form-control"  >    
                          </div>
                        </div>
                        <div style="display:none" class="rentPrice">
                          <div class="form-group" >
                              <label for="daily_rentprice"><?php echo e(trans('labels.dailyRentPrice')); ?> </label>        
                              <input type="text" name="daily_rentprice" value="<?php echo e($property->daily_rentprice ? $property->daily_rentprice : 0); ?>" class="form-control"  >    
                          </div> 
                          <div class="form-group" >
                              <label for="weekly_rentprice"><?php echo e(trans('labels.weeklyRentPrice')); ?> </label>        
                              <input type="text" name="weekly_rentprice" value="<?php echo e($property->weekly_rentprice ? $property->weekly_rentprice : 0); ?>" class="form-control"  >    
                          </div> 
                          <div class="form-group" >
                              <label for="month_rentprice"><?php echo e(trans('labels.monthRentPrice')); ?> </label>        
                              <input type="text" name="month_rentprice" value="<?php echo e($property->month_rentprice ? $property->month_rentprice : 0); ?>" class="form-control"  >    
                          </div> 
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <select class="field select2" name="car_brand" autofocus id="car_brand" onchange="filterCategory(this.value)" data-placeholder="<?php echo e(trans('labels.selectCarBrand')); ?>">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $carBrand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
                                      <option value="<?php echo e($brand->id); ?>" <?php echo e($property->car_brand ==  $brand->id ? 'selected="selected"' : ''); ?> ><?php echo e($brand->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>    
                                <?php endif; ?>  
                            </select>
                          </div>
                            ...
                            <select class="field select2" name="prop_category" autofocus  data-placeholder="<?php echo e(trans('labels.selectCategoryType')); ?>" id="filterCategorys" >
                              <option value=""><?php echo e(trans('labels.selectCategoryType')); ?></option>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $property_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                          ...
                                          <option value="<?php echo e($pro_cat->id); ?>" <?php if($pro_cat->id == $property->prop_category): ?>  selected  <?php endif; ?>  ><?php echo e($pro_cat->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>    
                                <?php endif; ?>  
                            </select>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <select class="field select2" name="year_of_car" autofocus id="year_of_car" data-placeholder="<?php echo e(trans('labels.yearOfCar')); ?>" >
                              <option value=""><?php echo e(trans('labels.selectCategoryType')); ?></option>
                                  ...
                                  <?php for($year = 1948; $year < date('Y',strtotime('now'))+1; $year++): ?>

                                    <option value="<?php echo e($year); ?>" <?php if($year == $property->year_of_car): ?>  selected  <?php endif; ?>><?php echo e($year); ?></option>
                                  <?php endfor; ?>  
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="kilometer" value="<?php echo e($property->kilometer); ?>" class="form-control" required autofocus>
                          </div>

                         <!--  <div class="form-group">
                              <label for="year_of_car"><?php echo e(trans('labels.yearOfCar')); ?> <span class="clsred">*</span></label>
                              <input type="text" name="year_of_car" value="<?php echo e($property->year_of_car); ?>" class="form-control" required autofocus>
                          </div> -->
                              ...
                              <select name="fueltype" class="field"  autofocus required>
                                     <option value=""><?php echo e(trans('labels.selectfuelType')); ?></option>
                                        <?php $__empty_1 = true; $__currentLoopData = $fueltype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ft): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
                                              <option value="<?php echo e(@$ft->id); ?>" <?php if(isset($property->fueltype) AND $property->fueltype == $ft->id): ?>  selected="selected" <?php endif; ?>><?php echo e(@$ft->name); ?></option>                          
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>    
                                        <?php endif; ?>                                
                              </select>
                                ...
                                <select name="city" id="city" class="field"  autofocus required>
                                     <option value=""><?php echo e(trans('labels.selectCity')); ?></option>
                                        <?php $__empty_1 = true; $__currentLoopData = $city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
                                              <option value="<?php echo e($ct->id); ?>" <?php if(isset($property->city) AND $property->city == $ct->id): ?>  selected="selected" <?php endif; ?>><?php echo e($ct->name); ?></option>                          
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <?php endif; ?>                               
                                </select>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="email" name="email" value="<?php echo e($property->email ? $property->email : ''); ?>"class="form-control" autofocus>
                          </div>    

                          <div class="form-group">
                              <label for="phone"><?php echo e(trans('labels.phone')); ?> </label>
                              <input type="text" name="phone" value="<?php echo e($property->phone  ? $property->phone : ''); ?>" class="form-control" autofocus>
                          </div>       

                          <div class="form-group" >
                              <label for="video"><?php echo e(trans('labels.video')); ?> </label>        
                              <input type="url" name="video" value="<?php echo e($property->video ? $property->video : ''); ?>" class="form-control"  >    
                          </div>             
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="gear_type" id="gear_type">
                                <option value="Automatic" <?php if(isset($property->gear_type)): ?> <?php echo e(old('gear_type',$property->gear_type)=="Automatic"? 'selected':''); ?> <?php endif; ?>><?php echo e(trans('labels.Automatic')); ?></option>
                                <option value="Manual" <?php if(isset($property->gear_type)): ?> <?php echo e(old('gear_type',$property->gear_type)=="Manual"? 'selected':''); ?> <?php endif; ?>><?php echo e(trans('labels.Manual')); ?></option>
                              </select>
                          </div>
