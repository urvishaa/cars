    ...
    <section class="detail-term">
        <div class="container">
          <div class="details gerti tert-ert">
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php if(count($result['showroomProperty'])): ?>
                    ...
                    <?php endif; ?>
                        <div class="row">
                            <?php $__empty_1 = true; $__currentLoopData = $result['showroomProperty']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $showroomPropertys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php @$modelName = DB::table('property_category')->where('id',$showroomPropertys->prop_category)->first(); ?>
                            <div class="col-lg-4 col-md-6">
                                <div class="single-popular-car">
                                    <div class="p-car-thumbnails">
                                         <a  href="<?php echo e(URL::to('/car_Detail/'.$showroomPropertys->id)); ?>">  
                                          <?php $image = DB::table('property_img')->where('property_id',$showroomPropertys->id)->first(); 
                                    ...
                                    <div class="p-car-content">
                                        <h3>
                                            <a href="<?php echo e(URL::to('/car_Detail/'.$showroomPropertys->id)); ?>"><?php echo e(@$showroomPropertys->property_name); ?></a>
                                            <?php if($showroomPropertys->pro_type == '1'): ?> 
                                                <?php if($showroomPropertys->sale_price !=''): ?><span class="price">$<?php echo e(@$showroomPropertys->sale_price); ?></span><?php endif; ?>
                                            <?php elseif($showroomPropertys->pro_type == '2'): ?>
                                                <?php if($showroomPropertys->month_rentprice !=''): ?><span class="price">$<?php echo e(@$showroomPropertys->month_rentprice); ?></span><?php endif; ?>
                                            <?php endif; ?>
                                           
                                        </h3>

                                        <h5><i class="fas fa-map-marker-alt"></i> <?php echo e($showroomPropertys->googleLocation); ?></h5>

                                        <div class="p-car-feature">
                                            <?php if($showroomPropertys->year_of_car !=''): ?><a href="javascript:void(0)"><?php echo e($showroomPropertys->year_of_car); ?></a><?php endif; ?>
                                            <?php if($showroomPropertys->gear_type == 'Automatic'): ?><a href="javascript:void(0)"><?php echo e(trans('labels.Automatic')); ?></a><?php elseif($showroomPropertys->gear_type == 'Manual'): ?><a href="javascript:void(0)"><?php echo e(trans('labels.Manual')); ?></a><?php endif; ?>
                                            ...
                                            <?php elseif(!isset($session['language']) AND $session['language'] == 'ar'): ?>
                         ...
                         <div style="margin-bottom: 25px;"> <?php echo e(@$result['showroomProperty']->links('vendor.pagination.default')); ?></div>
                </div>             
            </div>
          </div>          
        </div>
