<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
        <span class="sr-only"><i class="fas fa-bars"></i><?php echo e(trans('labels.toggle_navigation')); ?></span>
      </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <?php else: ?> 
                 <img class="user-image" src="<?php echo e(url('public/default-image.jpeg')); ?>" alt="profile picture">
              <?php endif; ?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <?php else: ?> 
                 <img  class="img-circle" src="<?php echo e(url('public/default-image.jpeg')); ?>" alt="profile picture">
              <?php endif; ?>
