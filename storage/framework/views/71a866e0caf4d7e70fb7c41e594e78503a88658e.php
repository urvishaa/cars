                    ...
                    <div class="centerdiv">
                        <div class="subcenter"> 
                          ...
                          <div class="form-group">
                                ...
                                <?php if($ads->image != ""): ?>
                                    <div class="col-md-2"><img src="<?php if(isset($ads->image)): ?><?php echo e(url('/public/adsImage/'.$ads->image )); ?> <?php endif; ?>" class="btn popup_image" height="100px" width="100px"/></div>
                                <?php else: ?>
