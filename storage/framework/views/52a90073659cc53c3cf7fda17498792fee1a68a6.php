...
/*function filterGlobal () {
    ...
    $(document).ready(function () { 
        $('#tabuseridpos').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "<?php echo e(url('admin/car_type/allposts')); ?>",
                     "dataType": "json",
                     "type": "POST",
    ...
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.carType')); ?></h3>    
    <p><a href="<?php echo e(url('/admin/car_type/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.carTypeList')); ?>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("/admin/car_type/carTypealldelete")); ?>',
        ...
        else   {  alert('Select atleast one car type'); }
    });
});
