...
function filterGlobal () {
    ...
    $(document).ready(function () { 
        $('#tabuseridpos').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "<?php echo e(route('admin.specification.allposts')); ?>",
                     "dataType": "json",
                     "type": "POST",
    ...
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.specification')); ?></h3>    
    <p><a href="<?php echo e(route('admin.specification.create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.specificationList')); ?>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(route("admin.specification.alldelete")); ?>',
