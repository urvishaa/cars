...
<h3 class="page-title"><?php echo e(trans('labels.newSpecification')); ?></h3>   


        <div class="panel panel-default programcrcls">
            
             <div class="panel-body">
                <form action="<?php echo e(route('admin.specification.save')); ?>" method="POST" enctype="multipart/form-data">
