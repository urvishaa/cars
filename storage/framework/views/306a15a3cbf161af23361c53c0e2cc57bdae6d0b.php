...
<h3 class="page-title">Edit Price</h3>  
        ...
        <div class="panel panel-default programcrcls">
             ...
             <div class="panel-body">
                ...
                <form action="<?php echo e(url('admin/price_list/update_price/'.$price->id)); ?>" method="POST" >
                <div class="panel-heading">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" value="<?php echo e($price->price); ?>" class="form-control" required autofocus>
                    </div>

                    <div class="form-group">
                        <label for="name">Name <span class="clsred">*</span></label>
                        <input type="text" name="name" value="<?php echo e($price->name); ?>" class="form-control" required autofocus>
                    </div>
