...
/*function filterGlobal () {
    ...
    <div class="box-header-main"><h3 class="page-title">Property Type</h3>    
    <p><a href="<?php echo e(url('/admin/property_type/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i>Add New</a>
