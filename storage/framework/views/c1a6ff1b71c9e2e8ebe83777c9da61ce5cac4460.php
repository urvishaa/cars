...
function filterGlobal () {
    ...
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.propertyCategory')); ?></h3>    
    <p><a href="<?php echo e(url('/admin/category/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.propertyCategoryList')); ?>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("/admin/category/propertyCategoryalldelete")); ?>',
