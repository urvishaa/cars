...
<script src="<?php echo asset('resources/views/admin/plugins/datatables/jquery.dataTables.min.js'); ?>"></script>
<script src="<?php echo asset('resources/views/admin/plugins/datatables/dataTables.bootstrap.min.js'); ?>"></script>
<!-- InputMask -->
