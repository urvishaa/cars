...
function filterGlobal () {
    ...
    $(document).ready(function () { 
        $('#tabuseridpos').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "<?php echo e(url('admin/category/allposts')); ?>",
                     "dataType": "json",
                     "type": "POST",
    ...
    <div class="box-header-main"><h3 class="page-title"><?php echo e(trans('labels.carModel')); ?></h3>    
    <p>
    <a href="<?php echo e(route('carModel.import.create')); ?>" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.import')); ?></a>
    <a href="<?php echo e(url('/admin/category/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.carModelList')); ?>
        ...
        <div class="prolisttabcls">
                ...
                <thead>
                    <tr>                        
                        ...
                        <th><?php echo e(trans('labels.carBrand')); ?></th>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("/admin/category/carCategoryalldelete")); ?>',
