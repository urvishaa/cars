...
$(document).ready(function () { 
    $('#tabuserid').DataTable({
        ...
        "serverSide": true,
        "ajax":{
                 "url": "<?php echo e(url('/admin/showRoomAdmin/allsearch')); ?>",
                 "dataType": "json",
                 "type": "POST",
    ...
    <div class="box-header-main">
        <h3 class="page-title"><?php echo e(trans('labels.showRoomAdmin')); ?> </h3>    
        <p><a href="<?php echo e(url('/admin/showRoomAdmin/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i><?php echo e(trans('labels.addNew')); ?></a>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           <?php echo e(trans('labels.showRoomAdmin')); ?>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'<?php echo e(url("admin/showRoomAdmin/alldelete")); ?>',
