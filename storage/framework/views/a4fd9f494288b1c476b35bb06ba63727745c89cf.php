...
function filterGlobal () {
    ...
    <div class="box-header-main"><h3 class="page-title">PDF Report List</h3>    
    <p><a href="<?php echo e(url('/admin/pdf_report/create')); ?>" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i>Add New</a>
