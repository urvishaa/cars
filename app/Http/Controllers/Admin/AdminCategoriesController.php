...
class AdminCategoriesController extends Controller
{
	public function allCategories($language_id){
		...
		->where('categories_description.language_id','=', $language_id )->where('parent_id', '0')->where('categories.categories_id', '!=','6')->get();
	...
	public function subcategories(){
		...
		->select(
			...
			'mainCategoryDesc.categories_id as mainCategoryDesc.categories_id',
			'subCategoryDesc.language_id'
			)
		->where('subCategories.parent_id', '>', '0')->where('subCategoryDesc.language_id', '1')->where('mainCategoryDesc.categories_id','!=','6')->	where('mainCategoryDesc.language_id', '1')->orderBy('subId','ASC')->paginate(20);
	...
	public function addsubcategory(Request $request){		
		...
		->where('parent_id', '0')->where('language_id','=', 1)->where('categories.categories_id','!=', 6)->get();
