...
class WebserviceController extends Controller
{
  ...
  { 
      ...
      if((empty($post['brandId'])))
      {
	    ...
	    try
	    {            
	        $results = DB::table('property_category')->select()->where('car_brand_id',$post['brandId'])->where('published',1)->get();          
