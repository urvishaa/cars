...
function filterGlobal () {
    ...
    <h3 class="page-title">{{ trans('labels.users') }} </h3>    
    <p><a href="{{ url('/admin/users/create') }}" class="btn btn-success"><i class="fa fa-edit" aria-hidden="true"> </i>{{ trans('labels.addNew') }}</a>
     <a class="btn btn-danger deletesellected" > <i class="fa fa-trash" aria-hidden="true"></i>{{ trans('labels.delete') }}</a> </p>
    </div>
    
    <div class="panel panel-default">
        <div class="panel-heading">
           {{ trans('labels.userList') }}
        </div>
