...
@section('content')
  ...
  <section class="content-header">
    <div class="box-header-main"><h3 class="page-title"> {{ trans('labels.rentalCompanies') }} </h3></div>
  </section>
            ...
            <div class="tab-content">
              <div class=" active tab-pane" id="profile">
                 {{--  @if (count($errors) > 0)
                  ...
                  @endif --}}
                <!-- The timeline -->
                    <form action="{{ url('admin/companyAdmin/updateShowRoomAdmin/'.$ShowRoomAdmin->myid) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                   {{-- {!! Form::open(array('url' =>'admin/companyAdmin', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!} --}}
              ...
              <div class="tab-pane" id="passwordDiv">
                <form action="{{ url('admin/companyAdmin/updateAdminPassword/'.$ShowRoomAdmin->myid) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                 {{-- {!! Form::open(array('url' =>'admin/companyAdmin/updateAdminPassword', 'onSubmit'=>'return validatePasswordForm()', 'id'=>'updateAdminPassword', 'name'=>'updateAdminPassword' , 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!} --}}
...
<script type="text/javascript">
  ...
  { 
    ...
    $.ajax({
        url: "{{ url('/admin/companyAdmin/zones') }}",
