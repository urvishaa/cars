                        ...
                        <div class="subcenter"> 
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="ar" value="{{ @$city->ar }}" class="form-control" required autofocus>
                          </div>
                           <div class="form-group">
                              <label for="name">{{ trans('labels.Kurdish') }} <span class="clsred">*</span></label>
                              <input type="text" name="ku" value="{{ @$city->ku }}" class="form-control" required autofocus>
                          </div>
