...
function filterGlobal () {
    ...
    <div class="box-header-main"><h3 class="page-title">{{ trans('labels.propertyCategory') }}</h3>    
    <p>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
           {{ trans('labels.propertyCategoryList') }}
        </div>
    ...
    $('.deletesellected').click(function(){ 
        ...
        if(checkValues !='')
        {
            ...
            {   return false;  }
                $.ajax({
                    type:'POST',
                    url:'{{ url("/admin/category/propertyCategoryalldelete") }}',
