...
@section('content')
 ...
 {{-- @if (count($errors) > 0)
  ...
  <section class="content-header">
    <div class="box-header-main"><h3 class="page-title">{{ trans('labels.StoreAdmin') }} </h3></div>
  </section>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class=" active tab-pane" id="profile">
                  ...
                  <!-- The timeline -->
                   {!! Form::open(array('url' =>'admin/StoreAdmin', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data','validate')) !!}
                      ...
                      <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">{{ trans('labels.Picture') }}<span style="color: red">*</span></label>
                      ...
                      <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">{{ trans('labels.Country') }}<span style="color: red">*</span></label>
                        <div class="col-sm-10">                       
                      ...
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">{{ trans('labels.ZipCode') }}<span style="color: red">*</span></label>
                      ...
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">{{ trans('labels.Phone') }}<span style="color: red">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="category">{{ trans('labels.proCategory') }} <span class="clsred">*</span></label>
                            <div class="col-sm-10">
                            <select class="field select2 form-control" name="category[]" autofocus required id="category" multiple="multiple" data-placeholder="{{ trans('labels.selectCategoryType') }}">
                                @forelse($result['procategory'] as $pro) 
                      ...
                      <div class='form-horizontal'>
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="password" class="form-control" id="password" name="password" placeholder="{{ trans('labels.newPassword') }}" required autofocus>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="password" class="form-control" id="re_password" name="re_password" placeholder="{{ trans('labels.reEnterPassword') }}" required autofocus>
                            <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AdminPasswordRestriction') }}</span>
                            <span style="display: none" class="help-block"></span>
                          </div>
                        </div>
              ...
              {{-- <div class="tab-pane" id="passwordDiv">
                 <div class='form-horizontal'>
                  ...
                  <div class="form-group">
                    <label for="re-password" class="col-sm-2 control-label">{{ trans('labels.Re-EnterPassword') }}<span style="color: red">*</span></label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="re_password" name="re_password" placeholder="{{ trans('labels.reEnterPassword') }}">
                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AdminPasswordRestriction') }}</span>
                      <span style="display: none" class="help-block"></span>
                    </div>
                  </div>
...
<script type="text/javascript">
  function zones(zone_val)
  {
    ...
    $.ajax({
        url: "{{ url('/admin/StoreAdmin/zones') }}",
        data: { zone_val: zone },
        type: "post",
