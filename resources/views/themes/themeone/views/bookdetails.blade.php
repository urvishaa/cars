                ...
                <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-md-6 car-detl-cls">
                          ...
                          <div class="form-group">
                              <label>{{ trans('labels.status') }} :</label><span>{{ $detail->status }}</span>
                          </div>
                         <!--  <div class="form-group">
                              <label>Status :</label>
                              <span>Pendig</span>
                          ...
                          <div class="car-main-imgcls ">
                                  ...
                                  @if($image != '')
                                    @if(file_exists(public_path().'/carImage/'.$image->img_name))
                                      <img src="{{ url('/public/carImage/'.$image->img_name) }}" alt="JSOFT"> 
                                    @else
