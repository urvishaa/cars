...
<?php 
 ...
 ?>
                                ...
                                <div class="item">
                                   <div class="single-popular-car">
                                            <div class="p-car-thumbnails">
                                                    <?php $image = DB::table('property_img')->where('property_id',@$sellcars->id)->first(); ?>

                                                    @if(file_exists(public_path().'/propertyImage/'.@$image->img_name)  AND @$image->img_name != '')

                                                        <img src="{{ URL::to('/public/propertyImage/'.$image->img_name) }}" >
                                                    @else
                                            ...
                                            <div class="p-car-content">
                                                <h3>
                                                    <a href="{{ URL::to('/car_Detail/'.$sellcars->id) }}">{{ @$sellcars->property_name }}</a>
                                                    <span class="price">{{ @$sellcars->year_of_car }}</span>
                                                </h3>
    ...
    <section class=" section-padding car-tre">
        <div class="container">
            <div class="bant-tre  property-slider1">
                        ...
                        <div class="img_real_home">
                            ...
                            <div class="real_content">
                                ...
                                <div class="estate_real">
                                    <ul class="esta_ul">
                                        <li class="esta_li">
                                            <a href="{{ URL::to('/companyPropertyList/'.$companies->myid) }}">{{ @$companies->first_name }}  {{ @$companies->last_name }}</a>
                    ...
                    <div class="item">
                        ...
                        <div class="real_content">
                            ...
                            <div class="estate_real">
                                <ul class="esta_ul">
                                    <li class="esta_li">
                                        <a href="{{ URL::to('/showroomPropertyList/'.$showrooms->myid) }}">{{ @$showrooms->first_name }}  {{ @$showrooms->last_name }}</a>
                ...
                <div class="col-lg-6">
                     <div class="about-content">
                        ...
                        <?php echo substr($result['about']->description,0,500); ?>
                            @if(strlen($result['about']->description)>200)
                    ...
                    <div class="button intro_button"><a href="javascript:void(0)" onclick="hidee();" id="test">{{ trans('labels.READ MORE') }}</a></div>
                </div>
                <!-- About Video End -->
            </div>
        </div>
