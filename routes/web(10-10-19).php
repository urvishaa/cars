...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		Route::group(['middleware' => 'admin'], function () { 
			...
			Route::post('category/update_propertyCategory/{id}','CarCategoryController@update_propertyCategory');
			Route::post('category/propertyCategoryalldelete','CarCategoryController@propertyCategoryalldelete');
...
Route::group(['namespace' => 'Web'], function () {	
	...
	Route::get('/companyList/{id}','DefaultController@companyPropertyList')->name('companylist');
	...
	Route::get('/showroomList/{id}','DefaultController@showroomPropertyList');
